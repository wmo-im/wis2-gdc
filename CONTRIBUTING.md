# Contributing to wis2-gdc

We welcome contributions to wis2-gdc, in the form of issues, bug fixes, or
...
wis2-gdc has the following modes of contribution:
...
Contributors to this project are expected to act respectfully toward others in accordance with the [Code of Conduct](https://github.com/wmo-im/wis2-gdc/blob/main/CODE_OF_CONDUCT.md).
...
* Perform __basic troubleshooting__ steps:
    ...
    * [__Search the issue
      tracker__](https://github.com/wmo-im/wis2-gdc/issues)
...
* __How can the we recreate your problem?__ Imagine that we have never used
  wis2-gdc before and have downloaded it for the first time. Exactly what steps
...
Your contribution will be under our [license](https://github.com/wmo-im/wis2-gdc/blob/main/LICENSE) as per [GitHub's terms of service](https://help.github.com/articles/github-terms-of-service/#6-contributions-under-repository-license).

### GitHub Commit Access

* Proposals to provide developers with GitHub commit access shall be emailed to the wis2-gdc [team](TODO). Proposals shall be approved by the wis2-gdc development team.  Committers shall be added by the project admin.
...
* All contributors shall be listed at https://github.com/wmo-im/wis2-gdc/graphs/contributors
* Unclaimed copyright, by default, is assigned to the main copyright holders as specified in https://github.com/wmo-im/wis2-gdc/blob/main/LICENSE
...
* __Base your new branch off of the appropriate branch__ on the main repository:
    ...
    * In general the released version of wis2-gdc is based on the ``main``
...
* __Please follow the coding conventions and style used in the wis2-gdc repository.__
* wis2-gdc endeavours to follow the
...
if they do not follow future plans for wis2-gdc.
