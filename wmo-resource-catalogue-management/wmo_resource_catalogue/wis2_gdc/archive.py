...
from wmo_resource_catalogue.env import (
    API_URL, API_URL_DOCKER, BROKER_URL, CENTRE_ID)
from wmo_resource_catalogue.wis2_gdc.registrar import Registrar
...
def restore_metadata(archive_zipfile: str) -> None:
    ...
    wme = generate_wme(CENTRE_ID, 'metadata-archive', 'INFO',
