...
from wmo_resource_catalogue.backend.base import BaseBackend

LOGGER = logging.getLogger(__name__)

WIS2_GDC_ES_SETTINGS = Path(__file__).resolve().parent.parent / 'resources' / 'wis2-gdc-es-settings.json'  # noqa
