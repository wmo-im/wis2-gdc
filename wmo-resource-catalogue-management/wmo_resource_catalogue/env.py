...
CENTRE_ID = os.environ.get('WMO_RESOURCE_CATALOGUE_CENTRE_ID')
...
GB_CENTRE_ID = None
GB_TOPIC = os.environ.get('WMO_RESOURCE_CATALOGUE_GB_TOPIC')
METADATA_ARCHIVE_SOURCE = Path(
    os.environ.get('WMO_RESOURCE_CATALOGUE_METADATA_ARCHIVE_SOURCE'))
METADATA_ARCHIVE_ZIPFILE = os.environ.get(
    'WMO_RESOURCE_CATALOGUE_METADATA_ARCHIVE_ZIPFILE')
